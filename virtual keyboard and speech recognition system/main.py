            ...
            for phrase in strlists.ON_STR:
                if phrase in text:
                    ...
                    try:
                        ...
                        engine.speak("Error loading voice typing: " + str(e))
                    break    
            

    for phrase in strlists.HAND_GESTURE_KEYBOARD_STR:
        if phrase in text:
            engine.speak("starting hand gesture keyboard master")
            engine.speak("point your finger at keys and make a fist to click")
            try:
                from virtual_keyboard import start_virtual_keyboard
                start_virtual_keyboard()
            except ImportError as e:
                engine.speak("Error loading hand gesture keyboard: " + str(e))
            break
